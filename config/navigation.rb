...
SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |primary|
    ...
    primary.item :settings, safe_join([fa_icon('cog fw'), t('settings.settings')]), settings_profile_url do |settings|
      ...
      settings.item :remote_accounts, safe_join([fa_icon('list fw'), t('settings.remote_accounts')]), settings_remote_accounts_url
    end
    ...
    primary.item :admin, safe_join([fa_icon('cogs fw'), t('admin.title')]), admin_reports_url, if: proc { current_user.admin? } do |admin|
      ...
      admin.item :secondlife, safe_join([fa_icon('hand-paper-o fw'), t('admin.secondlife.title')]), admin_secondlife_url
    end
