  ...
  render () {
    ...
    return (
      <div className='detailed-status__action-bar'>
        ...
        <div className='detailed-status__button'><IconButton animate={true} active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='iine--status' onClick={this.handleFavouriteClick} activeStyle={{ color: '#ca8f04' }} /></div>
